    ...
    public class PermissionConfiguration : IEntityTypeConfiguration<Permission>
    {
        public void Configure(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<Permission> builder)
        {
            ...
            builder.HasData(
                ...
                new Permission { Id = 20, Entity = "order", Action = "manage_read", Name = "order.manage_read", Description = "Admin: list and view orders", CreatedAt = staticDate },
                new Permission { Id = 21, Entity = "order", Action = "manage_update", Name = "order.manage_update", Description = "Admin: update order status", CreatedAt = staticDate },
